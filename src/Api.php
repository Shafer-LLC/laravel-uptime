...
class Api
{
    ...
    public function __construct(HttpClient $client, string $appId, string $appToken, string $endpoint = null)
    {
        ...
        $this->endpoint = $endpoint ?: 'cronmonitor.test';
    }
    ...
    private function headers(): array
    {
        return [
            ...
            'Uptime-Package-Version' => static::PACKAGE_VERSION,
        ];
    }

    /**
     * Calls a GET request on the Monitor Api.
     *
     * @param  string $url
     * @return \Codedeploy\Monitor\ApiResponse
     */
    ...
    /**
     * Calls a POST request on the monitor Api.
     *
     * @param  string $url
     * @param  array $data
     * @return \Codedeploy\Monitor\ApiResponse
